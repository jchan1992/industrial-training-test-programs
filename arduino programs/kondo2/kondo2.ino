...
//receive distance signal from bluetooth
//convert distance signal to angle 
//send angle signal to servos
//get current signal from servos
//send current signal to pc
